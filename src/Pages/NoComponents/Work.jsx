                    ...
                    <div className="col-md-6 order-md-1  work-section-column">
                        <div className="work-item">
                            ...
                            <div className="work-content">
                                ...
                                <a href="https://www.uci.cu/en/universidad/noticias/fici" className="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">FICI</a>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div className="col-md-6 order-md-2 work-section-column">
                        <div className="work-item">
                            ...
                            <div className="work-content">
                                ...
                                <p>Teach Logic, Discrete Mathematics, Algebra, Calculus.</p>
                                <a href="https://www.tusclasesparticulares.com/" className="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">tusclasesparticulares.com</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 order-md-1 work-section-column">
                    ...
                    <div className="col-md-6 order-md-1 work-section-column">
                        <div className="work-item">
                            ...
                            <div className="work-content">
                                ...
                                <a href="https://futur.upc.edu/28881368" className="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">CBTP</a>
                            </div> 
                        </div>
                    </div>
                    <div className="col-md-6 order-md-2 work-section-column">
